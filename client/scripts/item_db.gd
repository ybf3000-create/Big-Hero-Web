...
static func _init_all() -> void:
	...
	ITEMS = {
		...
		5: { "id": 5, "name": "天命卡",   "type": 0, "icon": "🃏", "desc": "使用后立即随机触发一次命运事件", "price": 0, "stack_max": 99, "stats": { "fate_event": 1 } },
		6: { "id": 6, "name": "打孔器",   "type": 0, "icon": "🛠", "desc": "为符合条件的装备增加1个宝石孔", "price": 0, "stack_max": 99, "stats": { "socket_tool": 1 } },
