...
export const BATTLE_SKILLS: BattleSkill[] = [
  { id: 1, name: "重击", icon: "⚔", target: 0, actionCd: 2, damagePct: 150, hits: 1 },
  { id: 2, name: "猛力一击", icon: "💥", target: 0, actionCd: 3, damagePct: 250, hits: 1 },
  { id: 3, name: "蓄力斩", icon: "⚡", target: 0, actionCd: 4, damagePct: 400, hits: 1 },
  { id: 4, name: "碎裂打击", icon: "🪨", target: 5, actionCd: 3, damagePct: 180, hits: 1, bonus: { ignoreDefPct: 20 } },
  { id: 5, name: "致命一击", icon: "🗡", target: 2, actionCd: 5, damagePct: 500, hits: 1, bonus: { executeThreshold: 0.3, executeMultiplier: 2 } },
  { id: 6, name: "终结技", icon: "🎯", target: 3, actionCd: 6, damagePct: 300, hits: 1, bonus: { missingHpScale: 1 } },
  { id: 7, name: "快速打击", icon: "⚡", target: 0, actionCd: 1, damagePct: 110, hits: 1, bonus: { ignoreDefPct: 10 } },
  { id: 8, name: "连击", icon: "💥", target: 0, actionCd: 1, damagePct: 55, hits: 2 },
  { id: 9, name: "旋风斩", icon: "🌀", target: 7, actionCd: 2, damagePct: 90, hits: 1 },
  { id: 10, name: "连射", icon: "🏹", target: 0, actionCd: 2, damagePct: 40, hits: 3 },
  { id: 11, name: "回旋镖", icon: "🪃", target: 7, actionCd: 2, damagePct: 110, hits: 1, bonus: { maxTargets: 2 } },
  { id: 12, name: "无尽打击", icon: "♾", target: 0, actionCd: 1, damagePct: 90, hits: 1, bonus: { stackStepPct: 10, maxStacks: 10 } },
  { id: 13, name: "冰冻射击", icon: "❄", target: 0, actionCd: 3, damagePct: 100, hits: 1, control: 1, controlDuration: 4 },
  { id: 14, name: "冰霜新星", icon: "🧊", target: 7, actionCd: 4, damagePct: 80, hits: 1, control: 5, controlDuration: 6 },
  { id: 15, name: "眩晕锤", icon: "🔨", target: 0, actionCd: 4, damagePct: 120, hits: 1, control: 2, controlDuration: 4 },
  { id: 16, name: "雷霆一击", icon: "⚡", target: 0, actionCd: 3, damagePct: 130, hits: 1, control: 4, controlDuration: 6 },
  { id: 17, name: "静默领域", icon: "🔇", target: 7, actionCd: 5, damagePct: 60, hits: 1, control: 3, controlDuration: 5 },
  { id: 18, name: "深度冻结", icon: "❄️", target: 0, actionCd: 6, damagePct: 200, hits: 1, control: 1, controlDuration: 6 },
  { id: 19, name: "腐蚀之触", icon: "💀", target: 4, actionCd: 4, damagePct: 100, hits: 1, control: 6, controlDuration: 8 },
  { id: 20, name: "时间凝滞", icon: "⏳", target: 7, actionCd: 6, damagePct: 50, hits: 1, control: 4, controlDuration: 6 },
  { id: 21, name: "护盾", icon: "🛡", target: 10, actionCd: 3, shieldPct: 300, shieldStat: "defense" },
  { id: 22, name: "治疗波", icon: "💚", target: 11, actionCd: 4, healPct: 150, healStat: "attack" },
  { id: 23, name: "铁壁姿态", icon: "🏰", target: 10, actionCd: 4, buffEffect: "def_x2", buffDuration: 4 },
  { id: 24, name: "坚毅", icon: "💪", target: 10, actionCd: 4, buffEffect: "tenacity", buffDuration: 4 },
  { id: 25, name: "生命绽放", icon: "🌿", target: 11, actionCd: 5, healPct: 5, healStat: "maxHpPct", bonus: { tickInterval: 1, tickCount: 5 } },
  { id: 26, name: "不屈意志", icon: "❤️‍🔥", target: 10, actionCd: 8, buffEffect: "undying", buffDuration: 4, bonus: { triggerHpPct: 0.2 } },
  { id: 27, name: "毒刃", icon: "🗡", target: 0, actionCd: 2, damagePct: 80, hits: 1, dotPct: 30, dotTickInterval: 2, dotTickCount: 4, dotType: "poison", dotMode: 0 },
  { id: 28, name: "烈焰灼烧", icon: "🔥", target: 7, actionCd: 3, damagePct: 60, hits: 1, dotPct: 30, dotTickInterval: 2, dotTickCount: 4, dotType: "burn", dotMode: 0 },
  { id: 29, name: "撕裂", icon: "🩸", target: 0, actionCd: 2, damagePct: 120, hits: 1, dotPct: 20, dotTickInterval: 2, dotTickCount: 3, dotType: "bleed", dotMode: 0 },
  { id: 30, name: "毒雾", icon: "☁️", target: 7, actionCd: 4, damagePct: 40, hits: 1, dotPct: 35, dotTickInterval: 2, dotTickCount: 5, dotType: "poison", dotMode: 0 },
  { id: 31, name: "剧毒爆发", icon: "💚", target: 0, actionCd: 5, bonus: { detonateDot: 1.5 } },
  { id: 32, name: "瘟疫传播", icon: "🦠", target: 7, actionCd: 6, bonus: { spreadDot: true } },
  { id: 33, name: "穿刺射击", icon: "🏹", target: 9, actionCd: 3, damagePct: 120, hits: 1, bonus: { pierceBackDamage: 80 } },
  { id: 34, name: "裂地斩", icon: "🌍", target: 9, actionCd: 4, damagePct: 180, hits: 1, bonus: { pierceBackDamage: 120, pierceBackSlow: 8 } },
  { id: 35, name: "穿透箭雨", icon: "🌧", target: 9, actionCd: 3, damagePct: 90, hits: 1, bonus: { pierceBackDamage: 90 } },
  { id: 36, name: "暗影突袭", icon: "🌑", target: 9, actionCd: 5, damagePct: 150, hits: 1, bonus: { pierceBackDamage: 100, pierceBackExecute: { threshold: 0.3, multiplier: 1.5 } } },
];
